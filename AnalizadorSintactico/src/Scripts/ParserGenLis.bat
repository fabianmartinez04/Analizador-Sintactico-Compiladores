...
java -jar "C:\Users\liset\OneDrive\Documentos\Ingenieria en Computacion\Computacion V Semestre\Compiladores e interpretes\Proyectos\Parser\lib\java-cup-11b.jar" -parser Scanner -symbols Sym Parser.cup
pause