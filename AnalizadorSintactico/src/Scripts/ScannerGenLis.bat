...
java -jar "C:\Users\liset\OneDrive\Documentos\Ingenieria en Computacion\Computacion V Semestre\Compiladores e interpretes\Proyectos\Parser\lib\jflex-1.6.1.jar" Scanner.flex
pause
